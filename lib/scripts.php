...
function roots_scripts() {
  wp_register_style('googleFonts', '//fonts.googleapis.com/css?family=Unica+One|Vollkorn:400italic,700italic,400,700', false);
  ...
  wp_register_script('roots_scripts', get_template_directory_uri() . '/assets/js/scripts.min.js', array('jquery'), '0fc6af96786d8f267c8686338a34cd38', true);
