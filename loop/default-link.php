...
<footer class="link-meta">
  <div class="link-info">
    ...
    <p class="link-provider">Source: <a href="<?php echo get_post_meta( get_the_ID(), '_url_embedly_provider_url', true ); ?>" target="_blank"><?php echo get_post_meta( get_the_ID(), '_url_embedly_provider_name', true ); ?></a></p>
